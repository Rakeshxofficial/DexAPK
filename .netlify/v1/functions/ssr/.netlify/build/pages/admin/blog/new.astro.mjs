...
const $$New = createComponent(async ($$result, $$props, $$slots) => {
  const title = "Add New Blog Post - Admin Dashboard";
  const description = "Create a new blog post in the admin dashboard";
...
Logout
</button> </div> </div> </div> </header> <!-- Main Content --> <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8"> <!-- Page Header --> <div class="mb-8"> <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Add New Blog Post</h1> <p class="text-gray-600 dark:text-gray-400 mt-2">Create a new blog article for your readers</p> </div> <!-- Blog Form --> ${renderComponent($$result2, "BlogForm", $$BlogForm, { "mode": "create" })} </main> </div> ` })} ${renderScript($$result, "/home/project/src/pages/admin/blog/new.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/project/src/pages/admin/blog/new.astro", void 0);

const $$file = "/home/project/src/pages/admin/blog/new.astro";
