import { e as createComponent, f as createAstro, m as maybeRenderHead, h as addAttribute, l as renderScript, r as renderTemplate } from './astro/server_DeKgRGar.mjs';
import 'kleur/colors';
import 'clsx';
...
Preview Article
</button> <div id="article-preview" class="hidden mt-4 p-6 bg-gray-50 dark:bg-gray-700 rounded-xl border border-gray-200 dark:border-gray-600"> <h4 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Article Preview:</h4> <div id="preview-content" class="prose prose-gray dark:prose-invert max-w-none"></div> </div> </div> </div> <!-- SEO Settings --> <div class="space-y-6"> <h3 class="text-lg font-semibold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2">
SEO Settings
