...
export async function GET() {
  ...
  try {
    ...
    // Fallback blog tags
    blogTags = [
      'android', 'tutorial', 'mod apk', 'guide', 'tips', 'review', 'news', 
      'technology', 'apps', 'games', 'productivity', 'music', 'video', 
      'entertainment', 'social', 'photography', 'security', 'installation',
      'premium', 'unlocked', 'features', 'download', 'mobile', 'smartphone'
    ];
  }
